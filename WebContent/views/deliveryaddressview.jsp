...
<!DOCTYPE html>
<spring:url value="/dodeliveryaddress" var="deliveryaddress_form" />
...
<body>
	...
	<div class="row">
		...
		<div class="right" style="background-color: white;">
			...
			<button id="myBtn">Thêm địa chỉ giao hàng</button>
			...
			<div id="myModal" class="modal">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<form name="deliveryaddress_form" id='deliveryaddress_form'
							modelAttribute="deliveryaddress_form" class="form-inline"
							action="${deliveryaddress_form}" method="post"
							...
							<div class="nhieuinput">
								...
								<div>
									<label>
										<p>Tỉnh / Thành phố (*)</p>
									</label> <input type="text" name="city" placeholder="Điền thành phố"
										required>
								</div>
								...
								<div>
									<label>
										...
										placeholder="Điền địa chỉ cụ thể ">
								</div>
						...
						<button onclick="doDeliveryAddress()" class="luuthongtin">
							<b>Lưu thông tin</b>
						</button>
					</div>
			...
			<div>
				<c:forEach var="m" items="${listDeliveryaddress}">
					<div class="column">
						<div class="diachicanhan">
							...
							<div id="myModal1" class="modal">
								...
								<div class="modal-content">
									<div class="modal-header">
										<span class="close1"><button onclick="turnoffpopup(${m.id})"
												class="nutclose1"
									...
									<div class="modal-body">
										...
										<form name="updatedeliveryaddress_form"
											id='updatedeliveryaddress_form'
											modelAttribute="updatedeliveryaddress_form"
											class="form-inline" action="${updatedeliveryaddress_form}"
							...
							<form name="deletedeliveryaddress_form" id='${m.id}'
								type="hidden" value="${m.id}"
								modelAttribute="deletedeliveryaddress_form" class="form-inline"
								action="${deletedeliveryaddress_form}" method="post"
	...
	<script type="text/javascript">
		...
		function doDeliveryAddress() {
			...
			if (document.deliveryaddress_form.name.value === '') {
				alert("Vui lòng nhập tên");
				return;
			}

			if (document.deliveryaddress_form.city.value === '') {
				alert("Vui lòng nhập thành phố");
				return;
			}

			if (document.deliveryaddress_form.district.value === '') {
				alert("Vui lòng nhập phường xã");
				return;
			}

			if (document.deliveryaddress_form.detailaddress.value === '') {
				alert("Vui lòng nhập địa chỉ");
				return;
			}

			if (document.deliveryaddress_form.phone.value === '') {
			...
			document.deliveryaddress_form.target = "_self";
			document.deliveryaddress_form.method = "post";
			document.deliveryaddress_form.submit();
